...
import { TrendingUp, TrendingDown, DollarSign, Coins, Wallet } from 'lucide-react';

function SummaLogo({ className = 'h-6 w-6' }: { className?: string }) {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="bg-primary/10 p-2 rounded-full">
              <SummaLogo className="h-6 w-6 text-primary" />
            </div>
            <span className="text-xl font-bold tracking-tight">Summa</span>
          </div>
